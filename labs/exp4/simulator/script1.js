...
{    
     ...
     document.getElementById('heading1').innerHTML = ": Gate 1";
...
{  
    ...
    document.getElementById('heading1').innerHTML = ": Gate 2";
    var y= document.getElementById("chooseone");
    y.style.visibility="hidden";
    document.getElementById("checkbutton").disabled=false;
     document.getElementById("img1").src="images/toggleoff1.png";
...
{ 
    ...
    document.getElementById('heading1').innerHTML = ": Gate 3";
    var y= document.getElementById("chooseone");
    y.style.visibility="hidden";
    document.getElementById("checkbutton").disabled=false;
...
{ 
    ...
    document.getElementById('heading1').innerHTML = ": Gate 4";
    var y= document.getElementById("chooseone");
    y.style.visibility="hidden";
    document.getElementById("checkbutton").disabled=false;
...
{  
    ...
    document.getElementById('heading1').innerHTML = ": Gate 5";
    var y= document.getElementById("chooseone");
    y.style.visibility="hidden";
...
{  
    ...
    document.getElementById('heading1').innerHTML = ": Gate 6";
    var y= document.getElementById("chooseone");
    y.style.visibility="hidden";
    document.getElementById("checkbutton").disabled=false;
     document.getElementById("img1").src="images/toggleoff1.png";
...
{ var z=document.getElementById("sel2").value;
   ...
   var r=document.getElementById("box1");
   r.style.visibility="visible";
   var q=document.getElementById("reset");
   q.style.visibility="visible";
 document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
   ...
   document.getElementById('heading').innerHTML = " &nbsp; IC-7404(1-INPUT NOT GATE IC)";   
...
{  var po=document.getElementById("chooseone");
   ...
   document.getElementById('heading').innerHTML = " &nbsp; IC-7432(2-INPUT OR GATE IC)";   
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-7408(2-INPUT AND GATE IC)"; 
   document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-7400(2-INPUT NAND GATE IC)"; 
    document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-7402(2-INPUT NOR GATE IC)";  
    document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-7486(2-INPUT EX-0R GATE IC)"; 
    document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-74266(2-INPUT EX-NOR GATE IC)";  
    document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-7411(3-INPUT AND GATE IC)";   
  document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-74HC4075(3-INPUT OR GATE IC)";   
   document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{ var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-7410(3-INPUT NAND GATE IC)";  
    document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.";
    var img = document.createElement("img");
     img.id = "figure1";
...
{  var po=document.getElementById("chooseone");
   ...
   var q=document.getElementById("reset");
   q.style.visibility="visible";
   document.getElementById('heading').innerHTML = " &nbsp; IC-7427(3-INPUT NOR GATE IC)"; 
   document.getElementById("myDropdown").innerHTML = "1. Select any one of the gate.<br>2. Make connections to the gate which is to be verified as shown in pin diagram of the IC.<br>";
    var img = document.createElement("img");
     img.id = "figure1";
...
function image1()
{
    ...
    {
        document.getElementById("dot").style="position:absolute; top :395px; left: 1130px;visibility:visible";
    }
    else 
         {
        document.getElementById("dot").style="position:absolute; top :438px; left: 1130px;visibility:visible";
    }
...
function image2()
{
    ...
    {
        document.getElementById("dot1").style="position:absolute; top :466px; left: 1172px;visibility:visible";
    }
    else if(img1.indexOf('toggleoff1')!= -1&& img2.indexOf('toggleon')!= -1 )
    {
        document.getElementById("dot1").style="position:absolute; top :426px; left: 1172px;visibility:visible";
    }
    else if(img1.indexOf('toggleon')!= -1&& img2.indexOf('toggleon')!= -1 )
    {
        document.getElementById("dot1").style="position:absolute; top :506px; left: 1172px;visibility:visible";
    }
    else 
         {
        document.getElementById("dot1").style="position:absolute; top :386px; left: 1172px;visibility:visible";
    }
...
function image3()
{
 ...
 if(img1.indexOf('toggleoff1')!= -1&& img2.indexOf('toggleoff1')!= -1 && img3.indexOf('toggleon')!= -1)
    {
        document.getElementById("dot3").style="position:absolute; top :404px; left: 1237px;visibility:visible";
    }
    else if(img1.indexOf('toggleoff1')!= -1&& img2.indexOf('toggleon')!= -1 && img3.indexOf('toggleoff1')!= -1)
    {
        document.getElementById("dot3").style="position:absolute; top :436px; left: 1237px;visibility:visible";
    }
    else if(img1.indexOf('toggleoff1')!= -1&& img2.indexOf('toggleon')!= -1 && img3.indexOf('toggleon')!= -1)
    {
        document.getElementById("dot3").style="position:absolute; top :470px; left: 1237px;visibility:visible";
    }
    else if(img1.indexOf('toggleon')!= -1&& img2.indexOf('toggleoff1')!= -1 && img3.indexOf('toggleoff1')!= -1)
    {
        document.getElementById("dot3").style="position:absolute; top :502px; left: 1237px;visibility:visible";
    }
    else if(img1.indexOf('toggleon')!= -1&& img2.indexOf('toggleoff1')!= -1 && img3.indexOf('toggleon')!= -1)
    {
        document.getElementById("dot3").style="position:absolute; top :534px; left: 1237px;visibility:visible";
    }
    else if(img1.indexOf('toggleon')!= -1&& img2.indexOf('toggleon')!= -1 && img3.indexOf('toggleoff1')!= -1)
    {
        document.getElementById("dot3").style="position:absolute; top :566px; left: 1237px;visibility:visible";
    }
    else if(img1.indexOf('toggleon')!= -1&& img2.indexOf('toggleon')!= -1 && img3.indexOf('toggleon')!= -1)
    {
        document.getElementById("dot3").style="position:absolute; top :598px; left: 1237px;visibility:visible";
    }
    else 
         {
        document.getElementById("dot3").style="position:absolute; top :372px; left: 1237px;visibility:visible";
    }
