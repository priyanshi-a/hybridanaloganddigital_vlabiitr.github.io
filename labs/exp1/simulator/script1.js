...
{    var z= document.getElementById("heading");
     ...
     document.getElementById('heading').innerHTML += "Measurement of inverting bias current";
     document.getElementById('myDropdown').innerHTML = "<b>1.</b>Click on the component button to place the component on the table.<br><b>2.</b>Make connections as per the circuit diagram.<br>";
     var img = document.createElement("img");
     img.id = "figure1";
     img.src = "images/image1ins.png";
     var src = document.getElementById("myDropdown");
     src.appendChild(img);
     document.getElementById('myDropdown').innerHTML += "<br><b>3.</b> Click on <b>'Check'</b> button to check connections. If correct, Click on <b>'Show output voltage'</b> button to view output on DMM.<br><b>4.</b> Calculate the inverting bias current using the formula:<br><center><b>I<sub>B1</sub> = V<sub>o</sub>/R<sub>f</sub></b></center><br><b>5.</b> Click on <b>'Result'</b> button and enter the claculated value.<br><b>6.</b> Click on <b>'Reset'</b> button and proceed in the same way to calculate the input bias current at non-inverting terminal.";
...
{ var z= document.getElementById("heading");
     ...
     a.style.visibility="hidden";
    document.getElementById("instruction").disabled=false;
    document.getElementById('heading').innerHTML += "Measurement of non-inverting bias current";
    document.getElementById('myDropdown').innerHTML = "<b>1.</b>Click on the component button to place the component on the table.<br><b>2.</b>Make connections as per the circuit diagram.<br>";
     var img = document.createElement("img");
     img.id = "figure1";
     ...
     var src = document.getElementById("myDropdown");
     src.appendChild(img);
     document.getElementById('myDropdown').innerHTML += "<br><b>3.</b> Click on <b>'Check'</b> button to check connections. If correct, Click on <b>'Show output voltage'</b> button to view output on DMM.<br><b>4.</b> Calculate the non-inverting bias current using the formula:<br><center><b>I<sub>B2</sub> = V<sub>o</sub>/R<sub>1</sub></b></center><br><b>5.</b> Click on <b>'Result'</b> button and enter the claculated value.<br><b>6.</b> The input bias current I<sub>B</sub> hence, can be calculated using the formula:<br><center><b>I<sub>B</sub> = (I<sub>B1</sub> + I<sub>B2</sub>)/2</b></center>where, I<sub>B1</sub> has to be calculated from previous part.";
    var y= document.getElementById("chooseone");
   y.style.visibility="hidden";
   var x= document.getElementById("Components");
   x.style.visibility="visible";
  ...
  popup.style.visibility="visible";
   ...
   y.style.visibility="hidden";
    ...
    document.getElementById('myDropdown').innerHTML = "<b>1.</b>Click on the component button to place the component on the table.<br><b>2.</b>Make connections as per the circuit diagram.<br>";
     var img = document.createElement("img");
     img.id = "figure1";
     img.src = "images/image3ins.png";
     var src = document.getElementById("myDropdown");
     src.appendChild(img);
     document.getElementById('myDropdown').innerHTML += "<br><b>3.</b> Click on <b>'Check'</b> button to check connections. If correct, Click on <b>'Show output voltage'</b> button to view output on DMM.<br><b>4.</b> Calculate the input offset current using the formula:<br><center><b>I<sub>io</sub> = V<sub>o</sub>/R<sub>f</sub></b></center><br><b>5.</b> Click on <b>'Result'</b> button and enter the claculated value.";
       var x= document.getElementById("Components");
   x.style.visibility="visible";
   document.getElementById("resistancebutton").addEventListener("click", function(){
   resistor1();
...
calculate3();
   ...
   y.style.visibility="hidden";
     ...
     document.getElementById('heading').innerHTML += "Measurement of input offset voltage";
     document.getElementById('myDropdown').innerHTML = "<b>1.</b>Click on the component button to place the component on the table.<br><b>2.</b>Make connections as per the circuit diagram.<br>";
     var img = document.createElement("img");
     img.id = "figure1";
     ...
     var src = document.getElementById("myDropdown");
     src.appendChild(img);
     document.getElementById('myDropdown').innerHTML += "<br><b>3.</b> Click on <b>'Check'</b> button to check connections. If correct, Click on <b>'Show output voltage'</b> button to view output (<b>V<sub>o</sub></b>) on DMM.<br><b>4.</b> Calculate the input offset voltage, <b>V<sub>io</sub></b> using the formula:<br><center><b>V<sub>io</sub> = (V<sub>o</sub> - I<sub>io</sub>R<sub>f</sub>)/(1+R<sub>f</sub>/R<sub>i</sub>)</b><br><b>5.</b> Click on <b>'Result'</b> button and enter the claculated value.";
       var x= document.getElementById("Components");
   x.style.visibility="visible";
     document.getElementById("resistancebutton").addEventListener("click", function(){
   resistor3();
...
calculate4();
   ...
   y.style.visibility="hidden";
     document.getElementById("instruction").disabled=false;
       ...
       document.getElementById('heading').innerHTML = "Measurement of slew rate";
       document.getElementById('myDropdown').innerHTML = "<b>1.</b>Click on the component button to place the component on the table.<br><b>2.</b>Make connections as per the circuit diagram.<br>";
     var img = document.createElement("img");
     img.id = "figure1";
     img.src = "images/image5ins.png";
     var src = document.getElementById("myDropdown");
     src.appendChild(img);
     document.getElementById('myDropdown').innerHTML += "<br><b>3.</b>The <b>input signal</b>* has to be taken from the red terminal of A.F. Oscillator while the other terminal has to be grounded.<br><b>4.</b>Also, feed the input signal to channel CH1 of the C.R.O and the output from Op-Amp IC must be fed to the channel CH2.<br><b>5.</b>Click on <b>'Check'</b> button to check connections. If correct, Click on <b>'Show output voltage'</b> button to view output.<br><b>6.</b>Increase the frequency of input signal using the dial** on A.F. Oscillator until output wave becomes triangular. This is the required frequency <b>f<sub>max</sub></b> in KHz.<br><b>7.</b> Calculate the slew rate using the formula:<br><center><b>S.R. = 2πf<sub>max</sub>V<sub>m</sub>/10<sup>6</sup> &nbsp; V/μs</center></b><br><b>8.</b> Click on <b>'Result'</b> button and enter the calculated value.<br>*Amplitude of input signal, 'Vm' is 3V.<br>**can be controlled by both mouse and keyboard.";
