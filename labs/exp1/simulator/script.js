    ...
    if(g.isConnected("ic741_7","VCC")&& g.isConnected("ic741_3",'GND')){
        ...
        if(g.isConnected("multimeter_GND","GND")){
            ...
            console.log("ic 4 not  connected to ")  
              ...
              if  (g.isConnected("ic741_2","resistance1_C1")&&g.isConnected("ic741_6","resistance1_A1")&&g.isConnected("ic741_2","cap_C1")&&g.isConnected("ic741_6","cap_A1")&&g.isConnected("multimeter_VCC","ic741_6")){alert("Right connections.");theorem1=true;document.getElementById("startbutton").disabled=false;document.getElementById("addtable").disabled=false;
            }
