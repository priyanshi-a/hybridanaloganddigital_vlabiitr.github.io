        ...
        console.log("IC 741 connected to supply");
            ...
            console.log("ic 2 not  connected to supply");
              ...
              if  (g.isConnected("ic741_2","GND")&&g.isConnected("ic741_6","diode1_A1")&&g.isConnected("ic741_6","diode2_C1")
                ...
                ){alert("Right Connections.");theorem1=true;document.getElementById("startbutton").disabled=false;document.getElementById("addtable").disabled=false;document.getElementById("checkbutton").disabled=true;
            }
